...
def main():
    ...
    doc.add_paragraph('ဘေးဘက် Menu မှ "KMC Tracking" သို့ ဝင်ရောက်ပါ။ ပေါင်မပြည့်သော ကလေးငယ်များအတွက် Kangaroo Mother Care (ရင်ခွင်ပိုက်စောင့်ရှောက်ခြင်း) ခံယူနေသော ကလေးစာရင်းကို ပြသပေးပါသည်။ ကလေးအလေးချိန် ပုံမှန်ရောက်ရှိသွားပါက KMC အောင်မြင်စွာ ပြီးဆုံးကြောင်း မှတ်သားနိုင်ပါသည်။')
    add_placeholder(doc)
